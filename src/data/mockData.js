...
export const orders = [
  {
    id: "DH001",
    storeId: "CH001",
    storeName: "CKitchen Quận 1",
    kitchenId: "BT001",
    status: "pending",
    priority: "high",
    createdAt: "2026-04-13T06:00:00",
    requestedDate: "2026-04-14",
    notes: "Cần gấp cho cuối tuần",
    items: [
      {
        productId: "SP001",
  ...
  },
  {
    id: "DH003",
    storeId: "CH003",
    storeName: "CKitchen Quận 7",
    kitchenId: "BT001",
    status: "producing",
    priority: "normal",
    createdAt: "2026-04-12T09:00:00",
    requestedDate: "2026-04-14",
    notes: "Tăng thêm 10% so với tuần trước",
    items: [
      {
        productId: "SP001",
        productName: "Phở Bò Truyền Thống",
  ...
  },
  {
    id: "DH008",
    storeId: "CH005",
    storeName: "CKitchen Bình Thạnh",
    kitchenId: "BT001",
    status: "cancelled",
    priority: "low",
    createdAt: "2026-04-08T09:00:00",
    requestedDate: "2026-04-10",
    notes: "Hủy do cửa hàng bảo trì",
    items: [
      {
        productId: "SP001",
        productName: "Phở Bò Truyền Thống",
  ...
  },
  {
    ...
    requestedDate: "2026-04-14",
    notes: "Đơn hàng lớn cho sự kiện",
    items: [
      {
        productId: "SP001",
        productName: "Phở Bò Truyền Thống",
